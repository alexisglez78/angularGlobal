...
export class DialogoInfoComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<any>,
    @Inject(MAT_DIALOG_DATA) public data: any, private gp: GlobalpaqService, private wsTienda: TiendaService) {
  ...
  verFactura(factura: string) {
    window.location.href = `https://sistema.globalpaq.net/facturas/${factura}`;
  }
