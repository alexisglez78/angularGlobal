...
export class DevolucionGuiaComponent implements OnInit {
    ...
    getDisponibles(paqueteria) {
        ...
        switch (paqueteria) {
            case 'fedex':
                dispaq = this.wsGlobalpaq.getGuiasDisponiblesFedex();
                break;
            case 'estafeta':
                dispaq = this.wsGlobalpaq.getGuiasDisponiblesEstafeta();
                break;
            case 'dhl':
                dispaq = this.wsGlobalpaq.getGuiasDisponiblesDhl();
                break;
            case 'redpack':
                dispaq = this.wsGlobalpaq.getGuiasDisponiblesRedpack();
                break;
            // case 'globalpaq':
            //     dispaq=this.wsGlobalpaq.getGuiasDisponiblesRedpack();
            //     break;
